...
- Para obtener código binario ejecutable tenemos 2 opciones:
  - __Compilar__ (Crea archivo ejecutable)
  - __Interpretar__
...
- La compilación/interpretación del código fuente se lleva a cabo en dos fases:
  1. __Análisis léxico__ (Comprobar ortografía)
  2. __Análisis sintáctico__ (Comprobar orden correcto de las palabras)
...
- Principal desventaja: Ejecución menos eficiente (Mas lenta).
...
- Tipos de __lenguajes declarativos__(Se utilizan poco salvo SQL):
...
- Tipos de __lenguajes imperativos__:
  ...
  - Multiparadigma(Pueden trabajar de varias formas): C++, Javascript
...
- Tipos de lenguajes según nivel de abstracción(Según la pontencia de las instrucciones): 
  - Bajo nivel(Cada operacion tiene su instrucción): ensamblador
  - Medio nivel: C
  - Alto nivel(Utiliza menos instrucciones para el mismo resultado): C++, Java


### Evolución

- Código binario(0 y 1)
- Ensamblador (mnemotecnico)
- Lenguajes estructurados 
- Lenguajes orientados a objetos(Organiza el código en clases)
...
- Experiencia previa (Tendencia a usar lenguajes que conoces)
- Herramientas de desarrollo (Compiladores, entornos de desarrollo, etc)
- Documentación disponible
- Base de usuarios (Mas ayuda)
- Reusabilidad (Poder utiluzar códigos pre-hechos, bibliotecas)
- Transportabilidad (Que funcione en muchas plataformas)
