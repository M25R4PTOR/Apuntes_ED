...
- Codigo intermedio u objeto (Binario que no se ejecuta)
- Codigo binario
- Bibliotecas (librerías) (Serie de archivos con código fuente que se puede distribuir)
- Compilar (Coger código fuente y traducirlo a código objeto)
